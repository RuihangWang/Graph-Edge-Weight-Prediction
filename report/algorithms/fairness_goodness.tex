...
\begin{figure}[htbp]
    ...
    \begin{axis}[xshift=-2.5cm,title= Fairness Distribution BTCAlphaNet ,xlabel=$f:$ Fairness score, ylabel=Frac. of vertices with Fairness $f$,xtick ={0,0.2,0.4,0.6,0.8,1},legend columns=5,legend style={font=\footnotesize},font=\footnotesize,width=6cm]
    \addplot table [x=$f:$ Fairness score, y=Frac. of vertices with Fairness $f$, col sep=comma] {F_distribution_BTCAlphaNet.csv};
    \end{axis}
    \end{tikzpicture}
    \hspace {0.05cm}
    \begin{tikzpicture}
    \begin{axis}[xshift=-2.5cm,title= Goodness Distribution BTCAlphaNet ,xlabel=$g:$ Goodness score, ylabel=Frac. of vertices with Goodness $g$,xtick ={-1,-0.5,0,0.5,1},legend columns=5,legend style={font=\footnotesize},font=\footnotesize,width=6cm]
    \addplot table [x=$g:$ Goodness score, y=Frac. of vertices with Goodness $g$, col sep=comma] {G_distribution_BTCAlphaNet.csv};
    \end{axis}
    \end{tikzpicture}
    \hspace {0.05cm}
    \begin{tikzpicture}
    \begin{semilogyaxis}[xshift=-2.5cm,title= Residual of BTCAlphaNet ,xlabel=Iteration Number, ylabel=Change in Value,xtick =data,legend columns=5,legend style={font=\footnotesize},font=\footnotesize,width=6cm]
